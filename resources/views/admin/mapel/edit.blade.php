...
<main class="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    @if ($errors->any())
        <div class="mb-5 rounded-xl border border-red-200 bg-red-50 px-4 py-3">
            ...
            <div class="flex items-start gap-3">
                ...
                <svg class="w-5 h-5 text-red-500 shrink-0 mt-0.5"
                     fill="none"
                     stroke="currentColor"
                     viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        <form action="{{ route('admin.mapel.update', $mataPelajaran->id) }}" method="POST">
            ...
            <div class="p-6 space-y-5">
                ...
                <div class="rounded-xl border border-orange-100 bg-orange-50 px-4 py-4">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <svg class="w-5 h-5 text-orange-500 shrink-0 mt-0.5"
                             fill="none"
                             stroke="currentColor"
                             viewBox="0 0 24 24">
                            <path stroke-linecap="round"
                        ...
                        <div>
                            <p class="text-xs font-bold text-orange-700">
                                Kode dan keterangan akan diperbarui otomatis
                            </p>

                            <p class="text-[11px] text-orange-600 mt-1 leading-relaxed">
                                Jika nama mata pelajaran diubah, sistem akan membuat ulang kode dan keterangan secara otomatis.
                            </p>
                        </div>
