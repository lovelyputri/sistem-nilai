...
<head>
    ...
    <title>Edit Guru | Sistem Nilai Guru</title>
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Masukkan nama lengkap" value="{{ old('name', $guru->name) }}" required>
                        </div>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="email" name="email" class="form-control" placeholder="guru@sekolah.sch.id" value="{{ old('email', $guru->email) }}" required>
                        </div>
                        @error('email')
                        <div class="error-message">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="nip" class="form-control" placeholder="Masukkan NIP" value="{{ old('nip', $guru->nip) }}" required>
                        </div>
                        @error('nip')
                        <div class="error-message">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                    ...
                    <!-- Password (Opsional) -->
                    <div class="form-group">
                        <label>Kata Sandi <span class="optional">(opsional - kosongkan jika tidak diubah)</span></label>
                        <div class="input-wrapper">
                            <span class="input-icon">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <!-- Konfirmasi Password -->
                    <div class="form-group">
                        <label>Konfirmasi Kata Sandi <span class="optional">(opsional)</span></label>
                        <div class="input-wrapper">
                            <span class="input-icon">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="info-note">
                        ...
                        <span>Kosongkan field password jika tidak ingin mengubah kata sandi.</span>
                    </div>
