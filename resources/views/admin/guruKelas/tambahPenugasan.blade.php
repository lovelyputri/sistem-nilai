...
<main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <div>
            ...
            <p class="text-sm text-slate-500 mt-1">
                Tentukan guru, mata pelajaran, dan kelas yang akan ditugaskan.
            </p>
        </div>
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <h3 class="font-bold text-red-700 text-sm">
                        Penugasan Tidak Dapat Ditambahkan
                    </h3>
    ...
    <div class="bg-white rounded-2xl
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <h2 class="text-base font-bold text-slate-800">
                        Formulir Penugasan Guru
                    </h2>

                    <p class="text-xs text-slate-400">
                        Tentukan guru, mata pelajaran, dan kelas.
                    </p>
        ...
        {{-- FORM --}}
        <form method="POST"
              action="{{ route('admin.guruKelas.storePenugasan') }}"
              id="penugasanForm"
