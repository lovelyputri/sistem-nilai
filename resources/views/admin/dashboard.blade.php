    ...
    <div class="relative bg-gradient-to-r from-orange-50 via-orange-50/40 to-amber-50/60 rounded-2xl p-6 lg:px-8 lg:py-6 border border-orange-100/80 flex flex-col md:flex-row items-center justify-between overflow-hidden shadow-sm">
        ...
        <div class="mt-4 md:mt-0 relative flex items-center justify-end shrink-0 pr-4">
            ...
            <div class="w-64 h-24 flex items-center justify-center relative">
                ...
                <svg
                    class="w-16 h-20 absolute -left-2 bottom-0"
                    viewBox="0 0 100 120"
                    fill="none"
                >
                    <path
                        d="M35 85 L65 85 L60 115 L40 115 Z"
                        fill="#F97316"
                    />

                    <path
                        d="M30 85 L70 85 L70 90 L30 90 Z"
                        fill="#EA580C"
                    />

                    <path
                        d="M50 85 Q 20 60 25 35 Q 45 45 50 85 Z"
                        fill="#10B981"
                    />

                    <path
                        d="M50 85 Q 80 60 75 35 Q 55 45 50 85 Z"
                        fill="#059669"
                    />

                    <path
                        d="M50 85 Q 50 20 50 15 Q 60 40 50 85 Z"
                        fill="#34D399"
                    />
                </svg>
        ...
        <div class="bg-white p-4 rounded-xl border border-slate-100 shadow-sm flex flex-col justify-between">
            ...
            <div class="mt-3 flex items-center justify-between">
                ...
                <a
                    ...
                    class="text-xs font-semibold text-emerald-500 hover:underline flex items-center gap-1"
                >
                    Lihat Detail &rarr;
                </a>
        ...
        <div class="bg-white p-4 rounded-xl border border-slate-100 shadow-sm flex flex-col justify-between">
            ...
            <div>
                ...
                <div class="mt-2 flex items-baseline space-x-2">
                    ...
                    <span class="text-2xl font-extrabold text-slate-800">
                        {{ $statistik['total_mata_pelajaran'] }}
                    </span>
            ...
            <div class="mt-3 flex items-center justify-between">
                ...
                <a
                    ...
                    class="text-xs font-semibold text-amber-500 hover:underline flex items-center gap-1"
                >
                    Lihat Detail &rarr;
                </a>
        ...
        <div class="bg-white p-4 rounded-xl border border-slate-100 shadow-sm flex flex-col justify-between">
            ...
            <div>
                ...
                <div class="mt-2 flex items-baseline space-x-2">
                    ...
                    <span class="text-2xl font-extrabold text-slate-800">
                        {{ number_format($statistikNilai['rata_rata'], 2, ',', '.') }}
                    </span>
            ...
            <div class="mt-3 flex items-center justify-between">
                ...
                <a
                    href="{{ route('admin.nilai.index') }}"
                    class="text-xs font-semibold text-purple-500 hover:underline flex items-center gap-1"
                >
                    Lihat Detail &rarr;
                </a>
        ...
        <div class="lg:col-span-4 bg-white p-5 rounded-xl border border-slate-100 shadow-sm flex flex-col justify-between">
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-2.5 mb-5">
                    ...
                    <div class="bg-emerald-50/60 p-2.5 rounded-lg border border-emerald-100/80 text-center">
                        ...
                        <p class="text-xl font-bold text-emerald-600 mt-0.5">
                            {{ number_format($statistikNilai['nilai_tertinggi'], 2, ',', '.') }}
                        </p>
                    ...
                    <div class="bg-rose-50/60 p-2.5 rounded-lg border border-rose-100/80 text-center">
                        ...
                        <p class="text-xl font-bold text-rose-600 mt-0.5">
                            {{ number_format($statistikNilai['nilai_terendah'], 2, ',', '.') }}
                        </p>
                    ...
                    <div class="bg-sky-50/60 p-2.5 rounded-lg border border-sky-100/80 text-center">
                        ...
                        <p class="text-xl font-bold text-sky-600 mt-0.5">
                            {{ number_format($statistikNilai['rata_rata'], 2, ',', '.') }}
                        </p>
                    ...
                    <div class="bg-purple-50/60 p-2.5 rounded-lg border border-purple-100/80 text-center">
                        ...
                        <p class="text-[11px] font-medium text-purple-600">
                            Siswa dengan Nilai
                        </p>

                        <p class="text-xl font-bold text-purple-600 mt-0.5">
                            {{ $statistikNilai['total_siswa_punya_nilai'] }}
                        </p>
                ...
                <div>
                    ...
                    <h4 class="text-xs font-bold text-slate-800 mb-3">
                        Distribusi Nilai
                    </h4>
                    ...
                    <div class="relative pt-6 pb-2 border-b border-slate-200">
                        ...
                        <div class="absolute inset-0 flex flex-col justify-between text-[10px] text-slate-300 pointer-events-none pb-5">
                            ...
                            <div class="flex items-center space-x-2">
                                <span class="w-4 text-right">80</span>
                                <div class="w-full border-t border-slate-100 border-dashed"></div>
                            </div>

                            <div class="flex items-center space-x-2">
                                <span class="w-4 text-right">60</span>
                                <div class="w-full border-t border-slate-100 border-dashed"></div>
                            </div>

                            <div class="flex items-center space-x-2">
                                <span class="w-4 text-right">40</span>
                                <div class="w-full border-t border-slate-100 border-dashed"></div>
                            </div>

                            <div class="flex items-center space-x-2">
                                <span class="w-4 text-right">20</span>
                                <div class="w-full border-t border-slate-100 border-dashed"></div>
                            </div>
                        ...
                        <div class="flex items-end justify-between pl-6 pr-2 h-36 relative z-10 space-x-2">
                            ...
                            @forelse($distribusiNilai as $rentang)
                                ...
                                <div class="flex-1 flex flex-col items-center justify-end h-full">
                                    ...
                                    <span class="text-[10px] font-bold text-slate-700 mb-1">
                                        {{ $rentang['total'] }}
                                    </span>

                                    <div
                                        class="w-full max-w-[28px] bg-orange-500 rounded-t-sm"
                                        style="height: {{ $rentang['total'] > 0 ? round(($rentang['total'] / $maxDistribusi) * 90) : 2 }}%;"
                                    ></div>
                            ...
                            @empty
                                ...
                                <p class="w-full text-center text-[11px] text-slate-400">
            ...
            <div>
                ...
                <div class="space-y-1.5 text-xs max-h-48 overflow-y-auto pr-1 border border-slate-100 rounded-lg p-2 bg-slate-50/50">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-1.5">
                                ...
                                <span
                                    ...
                                    style="background-color: {{ $donutColors[$index % count($donutColors)] }};"
                                ></span>
                    ...
                    @empty
                        ...
                        <p class="text-center text-[11px] text-slate-400 py-2">
                            Belum ada data nilai
                        </p>
                    ...
                    <table class="w-full text-left text-xs">
                        ...
                        <thead>
                            ...
                            <tr class="text-slate-400 border-b border-slate-100">
                                ...
                                <th class="pb-2.5 font-medium text-center">
                                    Aksi
                                </th>
                                ...
                                <tr>
                                    ...
                                    <td class="py-2.5 text-center">
                                        ...
                                        <a
                                            ...
                                            class="w-5 h-5 rounded-full border border-orange-200 text-orange-500 inline-flex items-center justify-center hover:bg-orange-50 mx-auto"
                                        >
                        ...
                        @if($aktivitas['type'] === 'nilai')
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-800 font-medium leading-snug">
                                    ...
                                    mendapat nilai baru untuk mata pelajaran
